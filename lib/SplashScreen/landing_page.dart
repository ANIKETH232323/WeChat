          ...
          child: Center(
            child: Column(
              children: [
                ...
                const Text(
                  "Welcome to WeChat",
                  style: TextStyle(fontSize: 30, fontFamily: 'OnePlus',fontWeight:FontWeight.bold),
                ),
                ...
                Row(
                  ...
                  children: [
                    RichText(
                        ...
                        text: TextSpan(
                            style: const TextStyle(color: kPrimaryColor,fontSize: 15,fontFamily: 'OnePlus',fontWeight:FontWeight.bold),
                          children: [
                ...
                ElevatedButton(onPressed: ()=> navigatorLoginScreen(context),
                  ...
                  child:const Text("Agree and Continue",style: TextStyle(fontFamily: 'OnePlus',fontWeight:FontWeight.bold,fontSize: 17)),
                )
              ],
            ),
          )),
